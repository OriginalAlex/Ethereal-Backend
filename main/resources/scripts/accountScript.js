...
function register() {
    ...
    performHTTPRequest("POST", "http://localhost:81/api/createaccount", '{"username":"' + username + '", "password"="' + password + '"}', function(response) {
        console.log(response);   
    });
}

function wipedb() {
    performHTTPRequest("POST", "http://localhost:81/api/wipedb", function() {
        console.log("wiped");
    }); 
}